...
<body>
		...
		<div class="navbar navbar-fixed-top">
			<div class="container-fluid cl">
				<a class="logo navbar-logo f-l mr-10 hidden-xs"
					href="/aboutHui.shtml">牛耳教育</a> <a
					class="logo navbar-logo-m f-l mr-10 visible-xs"
					href="/aboutHui.shtml">Newer</a> <span
	...
	<aside class="Hui-aside">
		<div class="menu_dropdown bk_2">
			...
			<dl id="menu-picture">
				<dt>
					<i class="Hui-iconfont">&#xe613;</i>咨询管理<i
						class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
				</dt>
				<dd>
					<ul>
						<li><a data-href="picture-list.html" data-title="添加咨询信息"
							href="javascript:void(0)">添加咨询信息</a></li>
						<li><a data-href="picture-list.html" data-title="咨询信息查询"
							href="javascript:void(0)">咨询信息查询</a></li>
					</ul>
				</dd>
			</dl>
			<dl id="menu-product">
				<dt>
					<i class="Hui-iconfont">&#xe620;</i>市场管理<i
						class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
				</dt>
				<dd>
					<ul>
						<li><a data-href="product-brand.html" data-title="个人数据查询"
							href="javascript:void(0)">个人数据查询</a></li>
						<li><a data-href="product-category.html" data-title="备案信息查询"
							href="javascript:void(0)">备案信息查询</a></li>
					</ul>
				</dd>
			</dl>
			<dl id="menu-system">
	...
	<script type="text/javascript" src="../js/h-ui.admin/js/H-ui.admin.js"></script>
	<!--/_footer 作为公共模版分离出去-->

	<!--请在下方写此页面业务相关的脚本-->
	<script type="text/javascript"
		src="../resource/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
	<script type="text/javascript">
		$(function() {

...
<body>
	<nav class="breadcrumb">
		...
		系统管理 <span class="c-gray en">&gt;</span> 部门信息列表 <a
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i>
					批量删除</a> <a class="btn btn-primary radius" data-title="添加部门"
				data-href="dept/adddept.jsp" onclick="Hui_admin_tab(this)"
				href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加部门</a></span> <span

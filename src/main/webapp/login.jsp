...
<link href="js/h-ui.admin/css/H-ui.login.css" rel="stylesheet"
	type="text/css" />
<link href="js/h-ui.admin/css/style.css" rel="stylesheet"
	type="text/css" />
<link href="resource/Hui-iconfont/1.0.8/iconfont.css" rel="stylesheet"
	type="text/css" />
<!--[if IE 6]>
<script type="text/javascript" src="resource/DD_belatedPNG_0.0.8a-min.js" ></script>
<script>DD_belatedPNG.fix('*');</script>
<![endif]-->
<title>牛耳教育信息管理系统</title>
</head>
<body>
	...
	<script type="text/javascript"
		src="${ctx}/resource/jquery/1.9.1/jquery.min.js"></script>
	<script type="text/javascript" src="${ctx}/js/h-ui/js/H-ui.min.js"></script>
</body>
</html>